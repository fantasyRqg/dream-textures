...
export DREAM_TEXTURES_SERVER=1
export DREAM_TEXTURES_SERVER_PORT=9765
'/Applications/Blender.app/Contents/Resources/4.0/python/bin/python3.10' -m dream_textures.generator_server